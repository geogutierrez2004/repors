 ...
 * storage trend line, backup / restore controls, and network storage configuration.
 */
...
export function StorageBackup({ sessionId, user, addToast }: Props): React.JSX.Element {
